      ...
      <div class="auto-container">
        ...
        <div class="sec-title centered" >
          <div class="title" style="
              ...
              border-bottom: 3px solid; /* Adjust the border thickness as needed */
              border-image: linear-gradient(90deg, #2E9F90 0%, #18615B 100%) 1;
              padding-bottom: 5px; /* Optional: Add some padding to space the text from the border */
              "
            >
            Send Us Message
          </div>
          <h2 style="background-image: linear-gradient(90deg, #2E9F90 0%, #18615B 100%);
                -webkit-background-clip: text;
                -webkit-text-fill-color: transparent;
                background-clip: text;
                text-fill-color: transparent;"
              >
              <span>We’re Ready To Help You</span> <br> Send Us Message
          </h2>
        </div>
        ...
        <div class="inner-container">
          ...
          <div class="contact-form">
            ...
            <!-- Contact Form -->
            <form method="POST" action="https://api.web3forms.com/submit" id="contact-form">
              <input type="hidden" name="access_key" value="99f5fa4d-9c47-4f51-9efb-4bc9e6863508">
              <input type="hidden" name="from_name" value="From Ezer Website">
              ...
              <div class="row clearfix">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 form-group text-center">
                  <button class="theme-btn btn-style-two">
                    <span class="txt" type="submit">Send Message <i class="fa fa-angle-right"></i></span>
                  </button>
                </div>
