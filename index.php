...
<html lang="en">
  ...
  <body class="xis-it-body">
    ...
    <!-- Start of Slider section
	  ============================================= -->
    <section id="xis-it-slider" class="xis-it-slider-section position-relative">
      <rs-module-wrap
        id="rev_slider_2_1_wrapper"
        data-alias="Xisma-It_Source"
        data-source="gallery"
        style="
          visibility: hidden;
        ...
        <rs-module id="rev_slider_2_1" style="" data-version="6.5.16">
          <rs-slides>
            ...
            <rs-slide
              ...
              data-key="rs-2"
              data-title="Slide"
              data-thumb="assets4/slider1.jpg"
              data-in="o:0;"
              data-out="a:false;"
              >
              <img
                src="assets4/slider1.jpg"
                alt=""
                title="slider1"
                width="5000"
                height="2637"
              ...
              <rs-layer
                ...
                data-type="text"
                data-rsp_ch="on"
                data-xy="x:c;xo:20px,16px,12px,3px;yo:395px,284px,226px,152px;"
                data-text="w:normal;s:70,60,45,25;l:80,70,50,30;fw:900;a:center;"
                data-frame_0="o:1;"
                data-frame_0_chars="d:5;o:0;rX:-90deg;oZ:-50;"
                data-frame_1="sp:1750;"
                data-frame_1_chars="e:power4.inOut;d:10;oZ:-50;"
                data-frame_999="o:0;st:w;"
                style="z-index: 9; font-family: var(--primary-font);"
                >Welcome To EZ<span>ER</span>
              </rs-layer>
              <!--  -->
              <!-- <rs-layer
                ...
                data-type="text"
                data-rsp_ch="on"
                data-xy="x:c;xo:32px,26px,19px,11px;y:m;yo:0px,0px,0px,0px;"
                data-text="w:normal;s:18,14,18,16;l:25,20,15,18;ls:6px,4px,3px,1px;fw:700;a:center;"
                data-frame_0="y:100%;"
                data-frame_0_mask="u:t;"
                data-frame_1="st:1750;sp:1750;"
              ...
              <rs-layer
                ...
                data-type="image"
                data-rsp_ch="on"
                data-xy="xo:2px,1px,0,0;y:m;yo:-11px,-9px,-6px,-7px;"
                data-text="w:normal;s:20,16,12,7;l:0,20,15,9;"
                data-dim="w:810px,668px,507px,346px;h:1091px,900px,683px,466px;"
                data-basealign="slide"
                data-frame_0="x:-100%;"
                data-frame_0_mask="u:t;"
                data-frame_1="st:1750;sp:2500;"
                data-frame_1_mask="u:t;"
                data-frame_999="o:0;st:w;"
                style="z-index: 8"
                ><img
                  src="assets4/shape1.png"
                  alt=""
                  class="tp-rs-img"
                  width="744"
                  height="1002"
              ...
              <rs-layer
                ...
                data-type="image"
                data-rsp_ch="on"
                data-xy="x:r;xo:-30px,-24px,-18px,-11px;y:b;yo:-2px,-1px,0,0;"
                data-text="w:normal;s:20,16,12,7;l:0,20,15,9;"
                data-dim="w:334px,275px,208px,128px;h:645px,532px,404px,249px;"
                data-basealign="slide"
                data-frame_0="x:right;"
                data-frame_1="st:2000;sp:2200;"
                data-frame_999="o:0;st:w;"
                style="z-index: 11"
                ><img
                  src="assets4/shape2.png"
                  alt=""
                  class="tp-rs-img"
                  width="334"
                  height="645"
              ...
              <rs-layer
                ...
                data-type="image"
                data-rsp_ch="on"
                data-xy="xo:606px,500px,379px,261px;yo:-9px,-7px,-5px,11px;"
                data-text="w:normal;s:20,16,12,7;l:0,20,15,9;"
                data-dim="w:234px,193px,146px,90px;h:402px,331px,251px,154px;"
                data-basealign="slide"
                data-frame_0="x:-175%;o:1;"
                data-frame_0_mask="u:t;x:100%;"
                data-frame_1="e:power3.out;st:1850;sp:1900;"
                data-frame_1_mask="u:t;"
                data-frame_999="o:0;st:w;"
                style="z-index: 12"
                >
              ...
              <rs-layer
                ...
                data-type="image"
                data-rsp_ch="on"
                data-xy="xo:225px,185px,140px,86px;y:b;yo:-35px,-28px,-21px,-12px;"
                data-text="w:normal;s:20,16,12,7;l:0,20,15,9;"
                data-dim="w:188px,155px,117px,72px;h:312px,257px,195px,120px;"
                data-basealign="slide"
                data-frame_0="x:175%;o:1;"
                data-frame_0_mask="u:t;x:-100%;"
                data-frame_1="e:power3.out;st:1950;sp:1800;"
                data-frame_1_mask="u:t;"
                data-frame_999="o:0;st:w;"
                style="z-index: 13"
                ><img
                  src="assets4/shape4.png"
                  alt=""
                  class="tp-rs-img"
                  width="188"
                  height="312"
              ...
              <rs-layer
                ...
                data-type="image"
                data-rsp_ch="on"
                data-xy="x:r;xo:125px,103px,78px,48px;y:b;yo:125px,103px,78px,48px;"
                data-text="w:normal;s:20,16,12,7;l:0,20,15,9;"
                data-dim="w:134px,110px,83px,51px;h:244px,201px,152px,93px;"
                data-basealign="slide"
                data-frame_0="sX:0.8;sY:0.8;"
                data-frame_1="e:power4.out;st:2100;sp:1800;"
                data-frame_999="o:0;st:w;"
                style="z-index: 14"
                ><img
                  src="assets4/shape6.png"
                  alt=""
                  class="tp-rs-img"
                  width="134"
                  height="244"
              ...
              <rs-layer
                ...
                data-type="text"
                data-rsp_ch="on"
                data-xy="x:c;xo:50px,41px,41px,9px;y:m;yo:0px,0px,0px,0px;"
            ...
            <rs-slide
              ...
              data-key="rs-8"
              data-title="Slide"
              data-thumb="assets4/slider2.jpg"
              data-in="o:0;"
              data-out="a:false;"
              >
              <img
                src="assets4/slider2.jpg"
                alt=""
                title="slider1"
                width="5000"
                height="2637"
              ...
              <!-- <rs-layer
                ...
                data-rsp_ch="on"
                data-xy="x:c;xo:20px,16px,12px,3px;yo:395px,284px,226px,152px;"
                data-text="w:normal;s:90,74,56,30;l:90,74,56,34;fw:700;a:center;"
                data-frame_0="o:1;"
                data-frame_0_chars="d:5;o:0;rX:-90deg;oZ:-50;"
                data-frame_1="sp:1750;"
                data-frame_1_chars="e:power4.inOut;d:10;oZ:-50;"
                data-frame_999="o:0;st:w;"
                style="z-index: 9; font-family: var(--primary-font);"
                >Empowering Businesses Through <br><span>Tailored Solutions</span>
              </rs-layer> -->
              <!--  -->
              <rs-layer
                id="slider-2-slide-2-layer-2"
                ...
                "
                >
                Your Business Partner for Success in the UAE
            ...
            <!-- Slider 3 -->
            <rs-slide style="position: absolute;" data-key="rs-9" data-title="Slide" data-thumb="assets4/slider3.jpg" data-in="o:0;" data-out="a:false;">
              <img src="assets4/slider3.jpg" alt="" title="slider1" width="5000" height="2637" class="rev-slidebg tp-rs-img" data-parallax="1" data-panzoom="d:10000;ss:100;se:110%;" data-no-retina>
              <!--
              -->
              <!-- <rs-layer
              ...
              <rs-layer
                ...
                data-frame_1_mask="u:t;"
                data-frame_999="o:0;st:w;"
                style="z-index:10;font-family:var(--primary-font);text-transform:uppercase;"
                >
                Empowering Businesses Through Tailored Solutions
              </rs-layer>
              <!-- 	-->
              <rs-layer
                ...
                style="z-index:8;"
                >
                <img src="assets4/shape1.png" alt="" class="tp-rs-img" width="744" height="1002" data-no-retina> 
              </rs-layer>
              <!-- 	-->
              <rs-layer
                ...
                style="z-index:11;"
                >
                <img src="assets4/shape2.png" alt="" class="tp-rs-img" width="334" height="645" data-no-retina> 
              </rs-layer>
              <!-- 	-->
              <rs-layer
                ...
                style="z-index:12;"
                >
                <img src="assets4/shape3.png" alt="" class="tp-rs-img" width="234" height="402" data-no-retina> 
              </rs-layer>
              <!-- 	-->
              <rs-layer
                ...
                style="z-index:13;"
                >
                <img src="assets4/shape4.png" alt="" class="tp-rs-img" width="188" height="312" data-no-retina> 
              </rs-layer>
              <!-- 	-->
              <rs-layer
    ...
    <section id="xis-it-about" class="xis-it-about-section position-relative" style="padding-bottom: 80px;">
      <div class="container">
        <div class="xis-it-about-content">
          <div class="row">
            <div class="col-lg-6">
              <div class="xis-it-about-img-exp-wrap d-flex">
                <div
                  class="xis-it-about-img-wrap wow fadeInLeft"
                  data-wow-delay="200ms"
                  data-wow-duration="1500ms"
                >
                  <div class="xis-it-about-img1 position-relative">
                    <img src="assets4/img/about/ab1.jpg" alt="" />
                  </div>
                </div>
                <div class="xis-it-about-img-exp">
                  <div
                    class="xis-it-about-img2 wow fadeInRight"
                  ...
                  <div class="xis-it-about-exp-wrap position-relative">
                    <span class="map-bg position-absolute"
                      ><img src="assets4/img/map.png" alt=""
                    /></span>
                    <!-- <div class="inner-text xis-it-headline pera-content">
                      <h3>
            ...
            <div class="col-lg-6">
              <div class="xis-it-about-text-wrap">
                <div
                  class="xis-it-section-title xis-it-headline pera-content wow fadeInUp"
                  data-wow-delay="200ms"
                  data-wow-duration="1500ms"
                  >
                  <span>About Us</span>
                  <h2 style="
                    background-image: -webkit-gradient(linear, left top, right top, from(#2E9F90), to(#18615B));
                    background-image: linear-gradient(90deg, #2E9F90 0%, #18615B 100%);
                  ...
                  <!-- ------------ -->
                  <div class="xis-dia-service-content-area">
                      <div class="row">
                          <div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                              <div class="xis-dia-service-inner-item text-center position-relative">
                                  <!-- <span class="xis-dia-service-shape position-absolute">
                                  ...
                                  <!-- <div class="xis-dia-service-more">
                                      <a class="text-uppercase" href="service-detail.html">Read More <i class="far fa-arrow-right"></i></a>
                                  </div> -->
                              </div>
                          </div>
                ...
                <!-- <div class="xis-it-about-video-play-wrap  d-flex align-items-center wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
								<div class="xis-it-video-play-img-btn position-relative">
									<div class="xis-it-video-img position-relative">
										<img src="assets4/img/about/ab-v1.jpg" alt="">
									</div>
									<div class="xis-it-video-btn">
										<a class="d-flex align-items-center video_box justify-content-center" href="https://www.youtube.com/watch?v=6zsr22OeF2I"><i class="fas fa-play"></i></a>
									</div>
								</div>
								<div class="xis-it-video-text xis-it-headline">
									<span class="video-slug">Don’t Pay Until It’s Done</span>
									<h3>We're Here for You From 
									Start to Finish</h3>
								</div>
							</div> -->
                <!-- <div class="xis-it-btn wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
    ...
    <!-- <section id="xis-it-pricing" class="xis-it-pricing-section position-relative" data-background="assets4/img/bg/price-bg.jpg" style="background-image: url(&quot;assets4/img/bg/price-bg.jpg&quot;);">
      <div class="container">
        ...
        <div class="xis-saas-help-content">
          <div class="row">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeInUp;">
              <div class="xis-saas-help-inner-item">
                <div class="xis-saas-thx-icon">
                  <img src="assets5/img/icon/ic5.png" alt="">
                </div>
                <div class="xis-saas-thx-text xis-saas-headline pera-content">
                  <h3>We help you get started—fast</h3>
                  <p>Whether it’s securing the right license or navigating regulatory requirements, we prepare businesses to launch with clarity and confidence.</p>
                </div>
              </div>
            </div>
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 200ms; animation-name: fadeInUp;">
              <div class="xis-saas-help-inner-item">
                <div class="xis-saas-thx-icon">
                  <img src="assets5/img/icon/ic6.png" alt="">
                </div>
                <div class="xis-saas-thx-text xis-saas-headline pera-content">
    ...
    <section id="xis-it-feature-2" class="xis-it-feature-section-2">
      <div class="container">
        <div class="xis-it-feature-content-2">
          <div class="row">
            <div class="col-lg-5">
              <div class="xis-it-feature-text-wrap-2">
                <div class="xis-it-section-title xis-it-headline pera-content  wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 200ms; animation-name: fadeInUp;">
        ...
        <div class="container">
            <div class="xis-contact-content position-relative">
                ...
                <div class="xis-btn d-flex justify-content-center">
                    <a class="d-flex justify-content-center align-items-center" href="contact.php">Contact Us <i class="far fa-arrow-right"></i></a>
                    <!-- <a class="d-flex justify-content-center align-items-center" href="#">Request Callback <i class="far fa-arrow-right"></i></a> -->
                </div>
            </div>
        </div>
    </section>
